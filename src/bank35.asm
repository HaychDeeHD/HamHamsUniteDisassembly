...
call_35_600f:
    ...
    Op82_Run data_01_7416                              ;; 35:6017 $82 $16 $74 $01
    ...
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:6040 $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:6045 $82 $c3 $74 $01
...
call_35_6058:
    ...
    Op82_Run data_01_7442                              ;; 35:6067 $82 $42 $74 $01
...
call_35_606f:
    ...
    Op82_Run data_01_7442                              ;; 35:6082 $82 $42 $74 $01
...
call_35_61ae:
    Op82_Run data_01_7416                              ;; 35:61ae $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:61b2 $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:61b6 $10 $04 $77 $6c $f7 $6c
...
call_35_624a:
    Op50_WriteByte wC31D, $00, $d1                     ;; 35:624a $50 $1d $c3 $00 $d1
    Op82_Run data_01_74c3                              ;; 35:624f $82 $c3 $74 $01
...
call_35_627d:
    ...
    Op50_WriteByte wC31D, $00, $d1                     ;; 35:6281 $50 $1d $c3 $00 $d1
    Op82_Run data_01_74c3                              ;; 35:6286 $82 $c3 $74 $01
...
call_35_62b4:
    Op50_WriteByte wC31D, $00, $d8                     ;; 35:62b4 $50 $1d $c3 $00 $d8
    Op82_Run data_01_74c3                              ;; 35:62b9 $82 $c3 $74 $01
...
call_35_62ee:
    Op82_Run data_01_7416                              ;; 35:62ee $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:62f2 $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:62f6 $10 $04 $77 $6c $f7 $6c
...
call_35_632a:
    Op50_WriteByte wC31D, $00, $08                     ;; 35:632a $50 $1d $c3 $00 $08
    Op82_Run data_01_74b1                              ;; 35:632f $82 $b1 $74 $01
...
call_35_634c:
    Op50_WriteByte wC31D, $00, $d4                     ;; 35:634c $50 $1d $c3 $00 $d4
    Op82_Run data_01_74c3                              ;; 35:6351 $82 $c3 $74 $01
...
call_35_637f:
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:637f $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:6384 $82 $c3 $74 $01
...
call_35_6397:
    Op82_Run data_01_7416                              ;; 35:6397 $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:639b $1e $1d $6f $1d
    Op10_HamChatWheel 8, $6cb2, $706b                  ;; 35:639f $10 $08 $b2 $6c $6b $70
...
call_35_65f7:
    Op1E_Call call_33_4e1d                             ;; 35:65f7 $1e $1d $4e $33
    Op18_Jump call_35_600f                             ;; 35:65fb $18 $0f $60 $35

call_35_65ff:
    Op82_Run data_01_7416                              ;; 35:65ff $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:6603 $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:6607 $10 $04 $77 $6c $f7 $6c
...
call_35_664e:
    ...
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:6652 $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:6657 $82 $c3 $74 $01
...
call_35_666a:
    ...
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:666e $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:6673 $82 $c3 $74 $01
...
call_35_6686:
    Op82_Run data_01_7416                              ;; 35:6686 $82 $16 $74 $01
...
call_35_6704:
    Op50_WriteByte wC31D, $00, $0c                     ;; 35:6704 $50 $1d $c3 $00 $0c
    Op82_Run data_01_74b1                              ;; 35:6709 $82 $b1 $74 $01
...
call_35_6f98:
    ...
    Op82_Run data_01_7416                              ;; 35:6fa0 $82 $16 $74 $01
    ...
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:6fc9 $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:6fce $82 $c3 $74 $01
...
call_35_6fe1:
    ...
    Op82_Run data_01_7442                              ;; 35:6ffc $82 $42 $74 $01
...
call_35_7004:
    ...
    Op82_Run data_01_7442                              ;; 35:7023 $82 $42 $74 $01
...
call_35_71c9:
    Op82_Run data_01_7416                              ;; 35:71c9 $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:71cd $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:71d1 $10 $04 $77 $6c $f7 $6c
...
call_35_7265:
    Op50_WriteByte wC31D, $00, $d8                     ;; 35:7265 $50 $1d $c3 $00 $d8
    Op82_Run data_01_74c3                              ;; 35:726a $82 $c3 $74 $01
...
call_35_72a8:
    Op50_WriteByte wC31D, $00, $d4                     ;; 35:72a8 $50 $1d $c3 $00 $d4
    Op82_Run data_01_74c3                              ;; 35:72ad $82 $c3 $74 $01
...
call_35_72fe:
    Op50_WriteByte wC31D, $00, $d2                     ;; 35:72fe $50 $1d $c3 $00 $d2
    Op82_Run data_01_74c3                              ;; 35:7303 $82 $c3 $74 $01
...
call_35_734d:
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:734d $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:7352 $82 $c3 $74 $01
...
call_35_7365:
    Op82_Run data_01_7416                              ;; 35:7365 $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:7369 $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:736d $10 $04 $77 $6c $f7 $6c
...
call_35_757c:
    Op50_WriteByte wC31D, $00, $d2                     ;; 35:757c $50 $1d $c3 $00 $d2
    Op82_Run data_01_74c3                              ;; 35:7581 $82 $c3 $74 $01
...
call_35_75af:
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:75af $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:75b4 $82 $c3 $74 $01
...
call_35_75c7:
    Op82_Run data_01_7416                              ;; 35:75c7 $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:75cb $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:75cf $10 $04 $77 $6c $f7 $6c
...
call_35_7614:
    Op50_WriteByte wC31D, $00, $d0                     ;; 35:7614 $50 $1d $c3 $00 $d0
    Op82_Run data_01_74c3                              ;; 35:7619 $82 $c3 $74 $01
...
call_35_762c:
    Op82_Run data_01_7416                              ;; 35:762c $82 $16 $74 $01
    Op1E_Call call_1d_6f1d                             ;; 35:7630 $1e $1d $6f $1d
    Op10_HamChatWheel 4, $6c77, $6cf7                  ;; 35:7634 $10 $04 $77 $6c $f7 $6c
