...
data_09_404d:
    ...
    ld   B, A                                          ;; 09:4051 $47
    inc  DE                                            ;; 09:4052 $13
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:4053 $fa $db $ce
    ld   H, A                                          ;; 09:4056 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:4057 $fa $da $ce
    ld   L, A                                          ;; 09:405a $6f
    ld   [HL], E                                       ;; 09:405b $73
    inc  L                                             ;; 09:405c $2c
    ld   [HL], D                                       ;; 09:405d $72
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:405e $fa $da $ce
...
data_09_4068:
    ...
    inc  DE                                            ;; 09:407e $13
.jr_09_407f:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:407f $fa $db $ce
    ld   H, A                                          ;; 09:4082 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:4083 $fa $da $ce
    ...
    ld   A, [DE]                                       ;; 09:40a0 $1a
    ld   [HL], A                                       ;; 09:40a1 $77
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:40a2 $fa $da $ce
    ld   L, A                                          ;; 09:40a5 $6f
    inc  DE                                            ;; 09:40a6 $13
    ld   [HL], E                                       ;; 09:40a7 $73
    inc  L                                             ;; 09:40a8 $2c
...
data_09_40ab:
    ...
    ld   B, A                                          ;; 09:40af $47
    inc  DE                                            ;; 09:40b0 $13
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:40b1 $fa $db $ce
    ld   H, A                                          ;; 09:40b4 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:40b5 $fa $da $ce
    ld   L, A                                          ;; 09:40b8 $6f
    ld   [HL], E                                       ;; 09:40b9 $73
    inc  L                                             ;; 09:40ba $2c
    ld   [HL], D                                       ;; 09:40bb $72
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:40bc $fa $da $ce
...
jp_09_40c6:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:40c6 $fa $db $ce
    ld   H, A                                          ;; 09:40c9 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:40ca $fa $da $ce
...
jp_09_40ec:
    ...
    inc  HL                                            ;; 09:4106 $23
    ld   D, [HL]                                       ;; 09:4107 $56
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:4108 $fa $db $ce
    ld   H, A                                          ;; 09:410b $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:410c $fa $da $ce
...
.jp_09_4157:
    ...
    ld   D, H                                          ;; 09:416a $54
    ld   E, L                                          ;; 09:416b $5d
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:416c $fa $db $ce
    ld   H, A                                          ;; 09:416f $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:4170 $fa $da $ce
...
data_09_418a:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:418a $fa $db $ce
    ld   H, A                                          ;; 09:418d $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:418e $fa $da $ce
...
jp_09_41b5:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:41b5 $fa $db $ce
    ld   H, A                                          ;; 09:41b8 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:41b9 $fa $da $ce
...
.jr_09_4208:
    ...
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:420a $fa $da $ce
...
.jr_09_4216:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:4216 $fa $da $ce
    ...
    ld   [HL+], A                                      ;; 09:4228 $22
    ld   [HL], A                                       ;; 09:4229 $77
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:422a $fa $da $ce
    ld   L, A                                          ;; 09:422d $6f
    inc  DE                                            ;; 09:422e $13
    ld   [HL], E                                       ;; 09:422f $73
    inc  L                                             ;; 09:4230 $2c
...
data_09_427c:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:427c $fa $db $ce
    ld   H, A                                          ;; 09:427f $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:4280 $fa $da $ce
...
data_09_42a1:
    ...
    ld   E, [HL]                                       ;; 09:42b3 $5e
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:42b4 $fa $db $ce
    ld   H, A                                          ;; 09:42b7 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:42b8 $fa $da $ce
...
data_09_42c0:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:42c0 $fa $db $ce
    ld   H, A                                          ;; 09:42c3 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:42c4 $fa $da $ce
...
.jr_09_42cf:
    ...
    ld   D, [HL]                                       ;; 09:42d2 $56
.jr_09_42d3:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:42d3 $fa $da $ce
    ld   L, A                                          ;; 09:42d6 $6f
    ld   [HL], E                                       ;; 09:42d7 $73
    inc  L                                             ;; 09:42d8 $2c
    ld   [HL], D                                       ;; 09:42d9 $72
...
data_09_42db:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 09:42db $fa $db $ce
    ld   H, A                                          ;; 09:42de $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:42df $fa $da $ce
    ld   L, A                                          ;; 09:42e2 $6f
    ld   A, [DE]                                       ;; 09:42e3 $1a
    ld   C, A                                          ;; 09:42e4 $4f
    inc  DE                                            ;; 09:42e5 $13
    ...
    inc  L                                             ;; 09:42e7 $2c
    ld   [HL], D                                       ;; 09:42e8 $72
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 09:42e9 $fa $da $ce
