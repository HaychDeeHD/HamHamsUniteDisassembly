...
data_0a_404d:
    ...
    ld   B, A                                          ;; 0a:4051 $47
    inc  DE                                            ;; 0a:4052 $13
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:4053 $fa $db $ce
    ld   H, A                                          ;; 0a:4056 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:4057 $fa $da $ce
    ld   L, A                                          ;; 0a:405a $6f
    ld   [HL], E                                       ;; 0a:405b $73
    inc  L                                             ;; 0a:405c $2c
    ld   [HL], D                                       ;; 0a:405d $72
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:405e $fa $da $ce
...
data_0a_4068:
    ld   A, [channelNum_CEE8]                          ;; 0a:4068 $fa $e8 $ce
    cp   A, $02                                        ;; 0a:406b $fe $02
    jr   NZ, .jr_0a_407f                               ;; 0a:406d $20 $10
    ld   HL, wNoteDurationPointerPointer_CED8          ;; 0a:406f $21 $d8 $ce
    ld   A, [HL+]                                      ;; 0a:4072 $2a
    ld   B, [HL]                                       ;; 0a:4073 $46
    ...
    inc  DE                                            ;; 0a:407e $13
.jr_0a_407f:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:407f $fa $db $ce
    ld   H, A                                          ;; 0a:4082 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:4083 $fa $da $ce
    ...
    ld   A, [DE]                                       ;; 0a:40a0 $1a
    ld   [HL], A                                       ;; 0a:40a1 $77
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:40a2 $fa $da $ce
    ld   L, A                                          ;; 0a:40a5 $6f
    inc  DE                                            ;; 0a:40a6 $13
    ld   [HL], E                                       ;; 0a:40a7 $73
    inc  L                                             ;; 0a:40a8 $2c
...
data_0a_40ab:
    ...
    ld   B, A                                          ;; 0a:40af $47
    inc  DE                                            ;; 0a:40b0 $13
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:40b1 $fa $db $ce
    ld   H, A                                          ;; 0a:40b4 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:40b5 $fa $da $ce
    ld   L, A                                          ;; 0a:40b8 $6f
    ld   [HL], E                                       ;; 0a:40b9 $73
    inc  L                                             ;; 0a:40ba $2c
    ld   [HL], D                                       ;; 0a:40bb $72
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:40bc $fa $da $ce
...
jp_0a_40c6:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:40c6 $fa $db $ce
    ld   H, A                                          ;; 0a:40c9 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:40ca $fa $da $ce
...
jp_0a_40ec:
    ld   A, [channelNum_CEE8]                          ;; 0a:40ec $fa $e8 $ce
    cp   A, $03                                        ;; 0a:40ef $fe $03
    jp   Z, .jp_0a_4157                                ;; 0a:40f1 $ca $57 $41
    ld   A, [channelControl_CEEB]                      ;; 0a:40f4 $fa $eb $ce
    ld   E, A                                          ;; 0a:40f7 $5f
    ...
    inc  HL                                            ;; 0a:4106 $23
    ld   D, [HL]                                       ;; 0a:4107 $56
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:4108 $fa $db $ce
    ld   H, A                                          ;; 0a:410b $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:410c $fa $da $ce
...
.jr_0a_414a:
    ...
    ret                                                ;; 0a:4156 $c9
.jp_0a_4157:
    ld   A, [channelControl_CEEB]                      ;; 0a:4157 $fa $eb $ce
    ld   E, A                                          ;; 0a:415a $5f
    ...
    ld   D, H                                          ;; 0a:416a $54
    ld   E, L                                          ;; 0a:416b $5d
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:416c $fa $db $ce
    ld   H, A                                          ;; 0a:416f $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:4170 $fa $da $ce
...
data_0a_418a:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:418a $fa $db $ce
    ld   H, A                                          ;; 0a:418d $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:418e $fa $da $ce
...
jp_0a_41b5:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:41b5 $fa $db $ce
    ld   H, A                                          ;; 0a:41b8 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:41b9 $fa $da $ce
...
.jr_0a_41da:
    push HL                                            ;; 0a:41da $e5
    ld   HL, wNoteDurationPointerPointer_CED8          ;; 0a:41db $21 $d8 $ce
    ld   A, [HL+]                                      ;; 0a:41de $2a
    ld   H, [HL]                                       ;; 0a:41df $66
    ld   L, A                                          ;; 0a:41e0 $6f
    inc  L                                             ;; 0a:41e1 $2c
...
.jr_0a_4208:
    ...
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:420a $fa $da $ce
...
.jr_0a_4216:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:4216 $fa $da $ce
    ...
    ld   [HL+], A                                      ;; 0a:4228 $22
    ld   [HL], A                                       ;; 0a:4229 $77
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:422a $fa $da $ce
    ld   L, A                                          ;; 0a:422d $6f
    inc  DE                                            ;; 0a:422e $13
    ld   [HL], E                                       ;; 0a:422f $73
    inc  L                                             ;; 0a:4230 $2c
...
data_0a_427c:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:427c $fa $db $ce
    ld   H, A                                          ;; 0a:427f $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:4280 $fa $da $ce
...
data_0a_42a1:
    ld   A, [channelControl_CEEB]                      ;; 0a:42a1 $fa $eb $ce
    sub  A, $d0                                        ;; 0a:42a4 $d6 $d0
    ld   E, A                                          ;; 0a:42a6 $5f
    ld   D, $00                                        ;; 0a:42a7 $16 $00
    ld   HL, wNoteDurationPointerPointer_CED8          ;; 0a:42a9 $21 $d8 $ce
    ld   A, [HL+]                                      ;; 0a:42ac $2a
    ld   H, [HL]                                       ;; 0a:42ad $66
    ld   L, A                                          ;; 0a:42ae $6f
    ld   A, [HL+]                                      ;; 0a:42af $2a
    ...
    ld   E, [HL]                                       ;; 0a:42b3 $5e
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:42b4 $fa $db $ce
    ld   H, A                                          ;; 0a:42b7 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:42b8 $fa $da $ce
...
data_0a_430d:
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA.high] ;; 0a:430d $fa $db $ce
    ld   H, A                                          ;; 0a:4310 $67
    ld   A, [wPointerToCurrentChannelSongProgramCounter_CEDA] ;; 0a:4311 $fa $da $ce
    ld   L, A                                          ;; 0a:4314 $6f
    ld   A, [DE]                                       ;; 0a:4315 $1a
    ld   C, A                                          ;; 0a:4316 $4f
    inc  DE                                            ;; 0a:4317 $13
